 ...
 *       Linux : javac Merge.java
 *       Windows: javac Merge.java
 *   
...
class Personagem 
{
    ...
    public static void intercalar( int esq, int meio, int dir, List<Personagem> perso, Log log )
    {
        ...
        for(i = 0; i < n1; i++){
            a1[i] = perso.get(esq+i).getActorName();
        }

        //Inicializar segundo subarray
        for(j = 0; j < n2; j++){
            a2[j] = perso.get(meio+j+1).getActorName();
        }
 ...
 * Classe Merge : Teste
 */
public class TesteMerge extends Personagem
{
    public static void main ( String [] args )
    {
        Scanner scan = new Scanner( System.in );
        
        Log log = new Log( "812839_mergesort.txt" );
        Personagem perso = new Personagem( );
