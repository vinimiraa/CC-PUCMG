 ...
 *       Linux : javac Personagem.java
 *       Windows: javac Personagem.java
 *   
 *  Para executar em terminal (janela de comandos):
 *       Linux : java Personagem
 *       Windows: java Personagem
 *   
*/
...
public class Personagem 
{
    ...
    {  
        ...
        else
        {
            ...
            // System.out.println( "tratada - " + tratada );
    ...
    public void setDateOfBirth ( String dateOfBirth ) 
    {
        ...
        String treatedDate = date[0] + "-" + date[1] + "-" + date[2];
    
        LocalDate dob = LocalDate.parse(treatedDate, DateTimeFormatter.ofPattern("dd-MM-yyyy"));
        setDateOfBirth( dob );
    }
    ...
    public void ler ( String id )
    {
        ...
        { 
            ...
            if( scan.hasNextLine( ) ) // Testar se tem mais alguma linha
            {
                boolean found = false;
    ...
    public static void main(String[] args) 
    {
        ...
        } while ( !isFim( input ) && scan.hasNextLine( ) ); // end do while
        scan.close( );
    } // end main ( )
} // end class
