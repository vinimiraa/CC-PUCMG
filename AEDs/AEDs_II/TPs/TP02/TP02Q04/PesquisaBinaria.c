 ...
 *       Linux : gcc -o PesquisaBinaria PesquisaBinaria.c
 *       Windows: gcc -o PesquisaBinaria PesquisaBinaria.c
 *   
 *  Para executar em terminal (janela de comandos):
 *       Linux : ./PesquisaBinaria
 *       Windows: PesquisaBinaria
 *   
*/
