 ...
 *       Linux : javac Bicolor.java
 *       Windows: javac Bicolor.java
 *   
 *  Para executar em terminal (janela de comandos):
 *       Linux : java Bicolor
 *       Windows: java Bicolor
 *   
*/
...
/**
 *  Classe Alvinegra : Arvore Binaria de Pesquisa
 */
class Alvinegra 
{
...
public class Bicolor extends Personagem
{
    public static void main ( String [] args ) throws Exception
    {
        ...
        Log log = new Log( "812839_alvinegra.txt" );
        Personagem perso = new Personagem( );
